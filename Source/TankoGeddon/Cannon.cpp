...
void ACannon::Fire()
{
	...
	if(CannonType==ECannonType::FireProjectile)
	{
		...
		if (GetOwner() && GetOwner() == GetWorld()->GetFirstPlayerController()->GetPawn())
		{
			if (ShootForceEffect)
			{
				FForceFeedbackParameters ShootForceEffectParameters;
				ShootForceEffectParameters.bLooping = false;
				ShootForceEffectParameters.Tag = "shootForceEffectParams";

				GetWorld()->GetFirstPlayerController()->ClientPlayForceFeedback(ShootForceEffect, ShootForceEffectParameters);
			}
